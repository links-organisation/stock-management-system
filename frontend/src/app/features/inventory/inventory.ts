...
export class Inventory implements OnInit {
  ...
  constructor(private productService: ProductService, private inventoryService: InventoryService, private cdr: ChangeDetectorRef) {}
  ...
  saveAdjust(product: Product): void {
    this.isSaving = true;
    this.inventoryService.adjust(product.id, this.newQuantity, this.comment || undefined).subscribe({
      next: (updated) => {
        this.isSaving = false;
        this.adjustingProductId = null;
